...
- ** Lịch sử scan** — lưu offline với Room Database
...
🔗 [Document Classifier API](https://huggingface.co/spaces/Hung371/document-classifier)
...
- Prompt engineering theo từng loại tài liệu:
  - Hóa đơn → tên công ty, MST, tổng tiền, VAT
  - Hợp đồng → bên A/B, thời hạn, giá trị
  - CMND → họ tên, ngày sinh, số CMND
